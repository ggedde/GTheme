jQuery(document).ready(function($){
    ...
    {
        $('.block-grid-format-slider .block-media-items-container').before('<div class="media-items-slider-pagination"></div>' +
        '<div class="media-items-slider-prev"></div>' +
    	'<div class="media-items-slider-next"></div>');

        $('.block-grid-format-slider .block-media-items-container').each(function(index){
    ...
    if(jQuery().colorbox)
    {
        $('.block-grid-format-gallery').each(function(index)
        {
            var block_index = $(this).closest('.block-container').attr('data-block-index');
