...
$block_fields = array();
$num_columns = apply_filters('gblocks_content_columns_max', 4);
...
for( $i = 1; $i <= $num_columns; $i++ ) {
	$block_fields[] = array (
	    ...
	    'instructions' => '',
	    'required' => 0,
	    'conditional_logic' => GBLOCKS::get_radio_num_conditionals('field_'.$block.'_num_columns', $i, $num_columns),
	    'wrapper' => array (
	        'width' => '',
	        'class' => '',
	        'id' => '',
...
return array (
	...
	'gblocks_settings' => array(
		'version' => '2.0',
		'icon' => 'gblockicon-content-2col',
		'description' => '<div class="row"><div class="columns medium-6"><img src="'.plugins_url().'/gblocks/gblocks/content/content_1.svg"><img src="'.plugins_url().'/gblocks/gblocks/content/content_2.svg"><img src="'.plugins_url().'/gblocks/gblocks/content/content_3.svg"></div><div class="columns medium-6"><p>Our most basic block. This block allows for the use of one, two or three columns of WordPress WYSIWYGs ( What You See Is What You Get ). The WYSIWYG allows you to add most of the basic types of content from images, to paragraph text as well as H1 – H6 headings. You can also create ordered and unordered lists as well as do type treatments like <strong>bold</strong> and <em>italic</em>.</p>
