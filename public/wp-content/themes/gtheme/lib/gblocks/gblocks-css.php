...
class GBLOCKS_CSS {
	...
	public function col($small=null, $med=null, $large=null, $xlarge=null)
	{
		...
		if(is_numeric($med))
		{
			$this->class[] = 'col-md-'.$med;
			$this->class[] = 'medium-'.$med;
		}

		if(is_numeric($large))
		{
			$this->class[] = 'col-lg-'.$large;
			$this->class[] = 'large-'.$large;
		}

		if(is_numeric($xlarge))
		{
			$this->class[] = 'col-xl-'.$xlarge;
	...
	public function get()
	{
		$blocks_name = GBLOCKS::$current_block_name;
		$classes = $this->class;
		$classes = apply_filters('gblocks_get_css', $classes, $blocks_name);
