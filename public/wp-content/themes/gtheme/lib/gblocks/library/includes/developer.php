<div class="gblocks-developers">
    ...
    <h4>There are 2 ways to include GBlocks in your theme:</h4>
        <ul>
            <li>By default the blocks will be filtered into "the_content()".  However, you can disable that in the <a href="admin.php?page=gblocks&section=advanced">Advanced Tab</a>.</li>
            <li>
                You can use the function to manually include them in your theme.
                <br><span class="gblocks-code-block"> &lt;?php GBLOCKS::display(); ?&gt;</span>
            </li>
        </ul>
    ...
    <h4>There are a few options to modify an existing block.</h4>
        <ul>
            <li>You can copy the block from:
                <br><span class="gblocks-code-block">wp-content/plugins/gblocks/gblocks-blocks</span>
                <br>and paste it in:
                <br><span class="gblocks-code-block">wp-content/themes/your-theme-folder/gblocks-blocks</span>
    ...
    <h4>There are a few options for adding your own blocks.</h4>
        <ul>
            <li>You can create your own WP plugin to include your own blocks—this feature uses the "gblocks" filter below.</li>
            <li>You can create a block folder in:
                <br><span class="gblocks-code-block">wp-content/themes/your-theme-folder/gblocks-blocks</span>
            </li>
            <li>You can use the "gblocks" filter below in your functions.php file.</li>
        </ul>

    <h2>Hooks - Actions and Filters</h2>
    <ul class="gblocks-hooks">
    <li>
        <h3>gblocks</h3>
        This filters through the available blocks.
        <blockquote>
        <label>Example 1: Adding Your Own</label>
        <textarea class="gblocks-code-block">
add_filter( 'gblocks', 'your_function' );
...
return $blocks;
    ...
    <li><h3>gblock_locations</h3>
        This filters through the locations to allow GBlocks.
        <blockquote>
        <label>Example 1: Adding a Location to Events where the ID is not 14</label>
        <textarea class="gblocks-code-block">
add_filter( 'gblock_locations', 'your_function' );
...
return $css;
    ...
    <li><h3>gblock_content_columns</h3>
        ...
        <textarea class="gblocks-code-block">
add_filter('gblock_content_columns', 'your_function');
...
function your_function($block_background_colors){
    ...
    <li><h3>gblock_hide_on_screen</h3>
        This filter gives the ability to hide other parts of the WordPress dashboard on GBlock enabled areas.
        <blockquote>
        <label>Example 1: Remove the content and excerpt fields.</label>
        <textarea class="gblocks-code-block">
add_filter('gblock_hide_on_screen', 'your_function');
function gblock_hide_fields($hidden){
	$hidden = array(
                0 => 'the_content',
                1 => 'excerpt'
	);
    ...
    <li><h3>gblock_column_widths</h3>
        ...
        <textarea class="gblocks-code-block">
add_filter('gblock_column_widths', 'your_function');
function your_function($column_width_options){
    ...
    <li><h3>gblock_mediacontent_columns</h3>
        ...
        <textarea class="gblocks-code-block">
add_filter('gblock_mediacontent_columns', 'your_function');
...
function your_function($block_background_colors){
    ...
    <li><h3>gblock_background_style</h3>
        ...
        <textarea class="gblocks-code-block">
add_filter('gblock_background_style', 'your_function');
function your_function($block_background_style){
    ...
    <li><h3>gblocks_responsive_image_settings</h3>
        This filters the settings for the responsive images.
        <blockquote>
        <label>Example 1: Adding a custom size and enabling downscale.</label>
        <textarea class="gblocks-code-block">
add_filter( 'gblocks_responsive_image_settings', 'custom_responsive_image_settings' );
function custom_responsive_image_settings($settings)
{
    ...
    <li><h3>gblock_link_fields</h3>
        This filters the fields for "GBLOCKS::get_link_fields" used to build button and links within the blocks.
        <blockquote>
        <label>Example 1: Adding a custom button type.</label>
        <textarea class="gblocks-code-block">
add_filter('gblock_link_fields', 'your_function');
function your_function($fields){
